...
for idx, pop in enumerate(n_people):
    ratio = pop / sum(n_people) * 100 # TODO) Calculate the ratio of new cases to each region’s population
...
for idx, pop in enumerate(n_covid):
    ratio = pop / sum(n_covid) * 100 # TODO) Calculate the ratio of new cases to each region’s population
